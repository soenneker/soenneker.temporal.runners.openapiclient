...
using Soenneker.Temporal.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Temporal.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Temporal:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/temporalio/api/refs/heads/master/openapi/openapiv3.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "TemporalOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
    ...
    private async ValueTask BuildAndPush(string gitDirectory, CancellationToken cancellationToken)
    {
        ...
        if (!successful)
            throw new InvalidOperationException("The generated Temporal OpenAPI client did not build successfully.");
